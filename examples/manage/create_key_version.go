...
func CreateKeyVersion (client *kmssdk.Client, keyId *string) (_result *kms20160120.CreateKeyVersionResponse, _err error) {
  request := &kms20160120.CreateKeyVersionRequest{
    KeyId: keyId,
  }
  _result = &kms20160120.CreateKeyVersionResponse{}
  _body, _err := client.CreateKeyVersion(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := CreateKeyVersion(client, keyId)
  if _err != nil {
    return _err
  }
