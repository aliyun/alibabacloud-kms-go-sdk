...
func UpdateSecret (client *kmssdk.Client, secretName *string, description *string) (_result *kms20160120.UpdateSecretResponse, _err error) {
  request := &kms20160120.UpdateSecretRequest{
    SecretName: secretName,
    Description: description,
  }
  _result = &kms20160120.UpdateSecretResponse{}
  _body, _err := client.UpdateSecret(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := UpdateSecret(client, secretName, description)
  if _err != nil {
    return _err
  }
