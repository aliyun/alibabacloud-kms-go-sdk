...
func DisableKey (client *kmssdk.Client, keyId *string) (_result *kms20160120.DisableKeyResponse, _err error) {
  request := &kms20160120.DisableKeyRequest{
    KeyId: keyId,
  }
  _result = &kms20160120.DisableKeyResponse{}
  _body, _err := client.DisableKey(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := DisableKey(client, keyId)
  if _err != nil {
    return _err
  }
