...
func RestoreSecret (client *kmssdk.Client, secretName *string) (_result *kms20160120.RestoreSecretResponse, _err error) {
  request := &kms20160120.RestoreSecretRequest{
    SecretName: secretName,
  }
  _result = &kms20160120.RestoreSecretResponse{}
  _body, _err := client.RestoreSecret(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := RestoreSecret(client, secretName)
  if _err != nil {
    return _err
  }
