...
func ListSecrets (client *kmssdk.Client, pageNumber *int32, pageSize *int32, filters *string, fetchTags *string) (_result *kms20160120.ListSecretsResponse, _err error) {
  request := &kms20160120.ListSecretsRequest{
  ...
  _body, _err := client.ListSecrets(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  filters := tea.String("your filters")
  fetchTags := tea.String("your fetchTags")
  response, _err := ListSecrets(client, tea.ToInt32(pageNumber), tea.ToInt32(pageSize), filters, fetchTags)
  if _err != nil {
    return _err
  }
