...
func UpdateRotationPolicy (client *kmssdk.Client, enableAutomaticRotation *bool, rotationInterval *string, keyId *string) (_result *kms20160120.UpdateRotationPolicyResponse, _err error) {
  request := &kms20160120.UpdateRotationPolicyRequest{
    EnableAutomaticRotation: enableAutomaticRotation,
    RotationInterval: rotationInterval,
    KeyId: keyId,
  }
  _result = &kms20160120.UpdateRotationPolicyResponse{}
  _body, _err := client.UpdateRotationPolicy(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := UpdateRotationPolicy(client, enableAutomaticRotation, rotationInterval, keyId)
  if _err != nil {
    return _err
  }
