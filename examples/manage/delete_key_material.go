...
func DeleteKeyMaterial (client *kmssdk.Client, keyId *string) (_result *kms20160120.DeleteKeyMaterialResponse, _err error) {
  request := &kms20160120.DeleteKeyMaterialRequest{
    KeyId: keyId,
  }
  _result = &kms20160120.DeleteKeyMaterialResponse{}
  _body, _err := client.DeleteKeyMaterial(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := DeleteKeyMaterial(client, keyId)
  if _err != nil {
    return _err
  }
