...
func SetDeletionProtection (client *kmssdk.Client, protectedResourceArn *string, enableDeletionProtection *bool, deletionProtectionDescription *string) (_result *kms20160120.SetDeletionProtectionResponse, _err error) {
  request := &kms20160120.SetDeletionProtectionRequest{
  ...
  _body, _err := client.SetDeletionProtection(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  protectedResourceArn := tea.String("your protectedResourceArn")
  enableDeletionProtection := tea.Bool(false)
  deletionProtectionDescription := tea.String("your deletionProtectionDescription")
  response, _err := SetDeletionProtection(client, protectedResourceArn, enableDeletionProtection, deletionProtectionDescription)
  if _err != nil {
    return _err
  }
