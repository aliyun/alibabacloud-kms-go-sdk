...
func ListKeyVersions (client *kmssdk.Client, pageNumber *int32, keyId *string, pageSize *int32) (_result *kms20160120.ListKeyVersionsResponse, _err error) {
  request := &kms20160120.ListKeyVersionsRequest{
    PageNumber: pageNumber,
    KeyId: keyId,
    PageSize: pageSize,
  }
  _result = &kms20160120.ListKeyVersionsResponse{}
  _body, _err := client.ListKeyVersions(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := ListKeyVersions(client, tea.ToInt32(pageNumber), keyId, tea.ToInt32(pageSize))
  if _err != nil {
    return _err
  }
