...
func CreateAlias (client *kmssdk.Client, aliasName *string, keyId *string) (_result *kms20160120.CreateAliasResponse, _err error) {
  request := &kms20160120.CreateAliasRequest{
    AliasName: aliasName,
    KeyId: keyId,
  }
  _result = &kms20160120.CreateAliasResponse{}
  _body, _err := client.CreateAlias(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := CreateAlias(client, aliasName, keyId)
  if _err != nil {
    return _err
  }
