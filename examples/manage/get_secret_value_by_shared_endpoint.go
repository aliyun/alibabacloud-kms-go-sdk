...
func GetSecretValueBySharedEndpoint (client *kmssdk.Client, fetchExtendedConfig *bool, secretName *string, versionId *string, versionStage *string) (_result *kms20160120.GetSecretValueResponse, _err error) {
  ...
  _body, _err := client.GetSecretValueBySharedEndpoint(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := GetSecretValueBySharedEndpoint(client, fetchExtendedConfig, secretName, versionId, versionStage)
  if _err != nil {
    return _err
  }
