...
func ListAliases (client *kmssdk.Client, pageNumber *int32, pageSize *int32) (_result *kms20160120.ListAliasesResponse, _err error) {
  request := &kms20160120.ListAliasesRequest{
    PageNumber: pageNumber,
    PageSize: pageSize,
  }
  _result = &kms20160120.ListAliasesResponse{}
  _body, _err := client.ListAliases(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := ListAliases(client, tea.ToInt32(pageNumber), tea.ToInt32(pageSize))
  if _err != nil {
    return _err
  }
