...
func ScheduleKeyDeletion (client *kmssdk.Client, pendingWindowInDays *int32, keyId *string) (_result *kms20160120.ScheduleKeyDeletionResponse, _err error) {
  request := &kms20160120.ScheduleKeyDeletionRequest{
    PendingWindowInDays: pendingWindowInDays,
    KeyId: keyId,
  }
  _result = &kms20160120.ScheduleKeyDeletionResponse{}
  _body, _err := client.ScheduleKeyDeletion(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  parseIntTmp, err := util.AssertAsString(tea.String("your pendingWindowInDays"))
  if err != nil {
    _err = err
    return _err
  }
  pendingWindowInDays := number.ParseInt(parseIntTmp)
  keyId := tea.String("your keyId")
  response, _err := ScheduleKeyDeletion(client, tea.ToInt32(pendingWindowInDays), keyId)
  if _err != nil {
    return _err
  }
