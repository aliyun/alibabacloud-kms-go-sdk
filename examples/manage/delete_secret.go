...
func DeleteSecret (client *kmssdk.Client, secretName *string, forceDeleteWithoutRecovery *string, recoveryWindowInDays *string) (_result *kms20160120.DeleteSecretResponse, _err error) {
  request := &kms20160120.DeleteSecretRequest{
    SecretName: secretName,
    ForceDeleteWithoutRecovery: forceDeleteWithoutRecovery,
    RecoveryWindowInDays: recoveryWindowInDays,
  }
  _result = &kms20160120.DeleteSecretResponse{}
  _body, _err := client.DeleteSecret(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  forceDeleteWithoutRecovery := tea.String("your forceDeleteWithoutRecovery")
  recoveryWindowInDays := tea.String("your recoveryWindowInDays")
  response, _err := DeleteSecret(client, secretName, forceDeleteWithoutRecovery, recoveryWindowInDays)
  if _err != nil {
    return _err
  }
