...
func ListKeys (client *kmssdk.Client, pageNumber *int32, pageSize *int32, filters *string) (_result *kms20160120.ListKeysResponse, _err error) {
  request := &kms20160120.ListKeysRequest{
    PageNumber: pageNumber,
    PageSize: pageSize,
    Filters: filters,
  }
  _result = &kms20160120.ListKeysResponse{}
  _body, _err := client.ListKeys(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := ListKeys(client, tea.ToInt32(pageNumber), tea.ToInt32(pageSize), filters)
  if _err != nil {
    return _err
  }
