...
func DeleteAlias (client *kmssdk.Client, aliasName *string) (_result *kms20160120.DeleteAliasResponse, _err error) {
  request := &kms20160120.DeleteAliasRequest{
    AliasName: aliasName,
  }
  _result = &kms20160120.DeleteAliasResponse{}
  _body, _err := client.DeleteAlias(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := DeleteAlias(client, aliasName)
  if _err != nil {
    return _err
  }
