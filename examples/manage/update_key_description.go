...
func UpdateKeyDescription (client *kmssdk.Client, description *string, keyId *string) (_result *kms20160120.UpdateKeyDescriptionResponse, _err error) {
  request := &kms20160120.UpdateKeyDescriptionRequest{
    Description: description,
    KeyId: keyId,
  }
  _result = &kms20160120.UpdateKeyDescriptionResponse{}
  _body, _err := client.UpdateKeyDescription(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := UpdateKeyDescription(client, description, keyId)
  if _err != nil {
    return _err
  }
