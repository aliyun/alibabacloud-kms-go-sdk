...
func ImportKeyMaterial (client *kmssdk.Client, importToken *string, encryptedKeyMaterial *string, keyId *string, keyMaterialExpireUnix *int64) (_result *kms20160120.ImportKeyMaterialResponse, _err error) {
  request := &kms20160120.ImportKeyMaterialRequest{
  ...
  _body, _err := client.ImportKeyMaterial(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  importToken := tea.String("your importToken")
  encryptedKeyMaterial := tea.String("your encryptedKeyMaterial")
  keyId := tea.String("your keyId")
  parseLongTmp, err := util.AssertAsString(tea.String("your keyMaterialExpireUnix"))
  if err != nil {
    _err = err
    return _err
  }
  keyMaterialExpireUnix := number.ParseLong(parseLongTmp)
  response, _err := ImportKeyMaterial(client, importToken, encryptedKeyMaterial, keyId, keyMaterialExpireUnix)
  if _err != nil {
    return _err
  }
