...
func DescribeKey (client *kmssdk.Client, keyId *string) (_result *kms20160120.DescribeKeyResponse, _err error) {
  request := &kms20160120.DescribeKeyRequest{
    KeyId: keyId,
  }
  _result = &kms20160120.DescribeKeyResponse{}
  _body, _err := client.DescribeKey(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := DescribeKey(client, keyId)
  if _err != nil {
    return _err
  }
