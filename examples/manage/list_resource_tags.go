...
func ListResourceTags (client *kmssdk.Client, keyId *string) (_result *kms20160120.ListResourceTagsResponse, _err error) {
  request := &kms20160120.ListResourceTagsRequest{
    KeyId: keyId,
  }
  _result = &kms20160120.ListResourceTagsResponse{}
  _body, _err := client.ListResourceTags(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := ListResourceTags(client, keyId)
  if _err != nil {
    return _err
  }
