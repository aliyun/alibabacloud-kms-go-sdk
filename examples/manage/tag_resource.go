...
func TagResource (client *kmssdk.Client, secretName *string, certificateId *string, keyId *string, tags *string) (_result *kms20160120.TagResourceResponse, _err error) {
  request := &kms20160120.TagResourceRequest{
  ...
  _body, _err := client.TagResource(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := TagResource(client, secretName, certificateId, keyId, tags)
  if _err != nil {
    return _err
  }
