...
func CancelKeyDeletion (client *kmssdk.Client, keyId *string) (_result *kms20160120.CancelKeyDeletionResponse, _err error) {
  request := &kms20160120.CancelKeyDeletionRequest{
    KeyId: keyId,
  }
  _result = &kms20160120.CancelKeyDeletionResponse{}
  _body, _err := client.CancelKeyDeletion(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := CancelKeyDeletion(client, keyId)
  if _err != nil {
    return _err
  }
