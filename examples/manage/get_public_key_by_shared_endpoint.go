...
func GetPublicKeyBySharedEndpoint (client *kmssdk.Client, keyVersionId *string, keyId *string) (_result *kms20160120.GetPublicKeyResponse, _err error) {
  request := &kms20160120.GetPublicKeyRequest{
    KeyVersionId: keyVersionId,
    KeyId: keyId,
  }
  _result = &kms20160120.GetPublicKeyResponse{}
  _body, _err := client.GetPublicKeyBySharedEndpoint(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  keyVersionId := tea.String("your keyVersionId")
  keyId := tea.String("your keyId")
  response, _err := GetPublicKeyBySharedEndpoint(client, keyVersionId, keyId)
  if _err != nil {
    return _err
  }
