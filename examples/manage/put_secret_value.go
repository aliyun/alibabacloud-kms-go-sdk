...
func PutSecretValue (client *kmssdk.Client, secretName *string, versionId *string, secretDataType *string, versionStages *string, secretData *string) (_result *kms20160120.PutSecretValueResponse, _err error) {
  request := &kms20160120.PutSecretValueRequest{
  ...
  _body, _err := client.PutSecretValue(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  versionStages := tea.String("your versionStages")
  secretData := tea.String("your secretData")
  response, _err := PutSecretValue(client, secretName, versionId, secretDataType, versionStages, secretData)
  if _err != nil {
    return _err
  }
