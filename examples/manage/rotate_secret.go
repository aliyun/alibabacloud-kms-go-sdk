...
func RotateSecret (client *kmssdk.Client, secretName *string, versionId *string) (_result *kms20160120.RotateSecretResponse, _err error) {
  request := &kms20160120.RotateSecretRequest{
    SecretName: secretName,
    VersionId: versionId,
  }
  _result = &kms20160120.RotateSecretResponse{}
  _body, _err := client.RotateSecret(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := RotateSecret(client, secretName, versionId)
  if _err != nil {
    return _err
  }
