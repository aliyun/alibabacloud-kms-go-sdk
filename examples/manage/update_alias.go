...
func UpdateAlias (client *kmssdk.Client, aliasName *string, keyId *string) (_result *kms20160120.UpdateAliasResponse, _err error) {
  request := &kms20160120.UpdateAliasRequest{
    AliasName: aliasName,
    KeyId: keyId,
  }
  _result = &kms20160120.UpdateAliasResponse{}
  _body, _err := client.UpdateAlias(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  aliasName := tea.String("your aliasName")
  keyId := tea.String("your keyId")
  response, _err := UpdateAlias(client, aliasName, keyId)
  if _err != nil {
    return _err
  }
