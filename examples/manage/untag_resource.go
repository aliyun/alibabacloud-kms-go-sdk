...
func UntagResource (client *kmssdk.Client, secretName *string, tagKeys *string, certificateId *string, keyId *string) (_result *kms20160120.UntagResourceResponse, _err error) {
  request := &kms20160120.UntagResourceRequest{
  ...
  _body, _err := client.UntagResource(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  tagKeys := tea.String("your tagKeys")
  certificateId := tea.String("your certificateId")
  keyId := tea.String("your keyId")
  response, _err := UntagResource(client, secretName, tagKeys, certificateId, keyId)
  if _err != nil {
    return _err
  }
