...
func UpdateSecretRotationPolicy (client *kmssdk.Client, enableAutomaticRotation *bool, rotationInterval *string, secretName *string) (_result *kms20160120.UpdateSecretRotationPolicyResponse, _err error) {
  request := &kms20160120.UpdateSecretRotationPolicyRequest{
    EnableAutomaticRotation: enableAutomaticRotation,
    RotationInterval: rotationInterval,
    SecretName: secretName,
  }
  _result = &kms20160120.UpdateSecretRotationPolicyResponse{}
  _body, _err := client.UpdateSecretRotationPolicy(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := UpdateSecretRotationPolicy(client, enableAutomaticRotation, rotationInterval, secretName)
  if _err != nil {
    return _err
  }
