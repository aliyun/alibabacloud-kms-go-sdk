...
func EnableKey (client *kmssdk.Client, keyId *string) (_result *kms20160120.EnableKeyResponse, _err error) {
  request := &kms20160120.EnableKeyRequest{
    KeyId: keyId,
  }
  _result = &kms20160120.EnableKeyResponse{}
  _body, _err := client.EnableKey(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := EnableKey(client, keyId)
  if _err != nil {
    return _err
  }
