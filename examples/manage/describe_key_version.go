...
func DescribeKeyVersion (client *kmssdk.Client, keyVersionId *string, keyId *string) (_result *kms20160120.DescribeKeyVersionResponse, _err error) {
  request := &kms20160120.DescribeKeyVersionRequest{
    KeyVersionId: keyVersionId,
    KeyId: keyId,
  }
  _result = &kms20160120.DescribeKeyVersionResponse{}
  _body, _err := client.DescribeKeyVersion(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := DescribeKeyVersion(client, keyVersionId, keyId)
  if _err != nil {
    return _err
  }
