...
func DescribeSecret (client *kmssdk.Client, secretName *string, fetchTags *string) (_result *kms20160120.DescribeSecretResponse, _err error) {
  request := &kms20160120.DescribeSecretRequest{
    SecretName: secretName,
    FetchTags: fetchTags,
  }
  _result = &kms20160120.DescribeSecretResponse{}
  _body, _err := client.DescribeSecret(request)
  if _err != nil {
    return _result, _err
  }
  _result = _body
...
func _main (args []*string) (_err error) {
  ...
  response, _err := DescribeSecret(client, secretName, fetchTags)
  if _err != nil {
    return _err
  }
