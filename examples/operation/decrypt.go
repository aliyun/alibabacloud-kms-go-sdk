...
func Decrypt (client *kmssdk.Client, paddingMode *string, aad []byte, ciphertextBlob []byte, keyId *string, iv []byte, algorithm *string) (_result *dedicatedkmssdk.DecryptResponse, _err error) {
  request := &dedicatedkmssdk.DecryptRequest{
  ...
  _result = &dedicatedkmssdk.DecryptResponse{}
...
func _main (args []*string) (_err error) {
  ...
  response, _err := Decrypt(client, paddingMode, aad, ciphertextBlob, keyId, iv, algorithm)
  if _err != nil {
    return _err
  }
