...
func AdvanceGenerateDataKey (client *kmssdk.Client, aad []byte, keyId *string, numberOfBytes *int32) (_result *dedicatedkmssdk.AdvanceGenerateDataKeyResponse, _err error) {
  request := &dedicatedkmssdk.AdvanceGenerateDataKeyRequest{
    Aad: aad,
    KeyId: keyId,
    NumberOfBytes: numberOfBytes,
  }
  _result = &dedicatedkmssdk.AdvanceGenerateDataKeyResponse{}
...
func _main (args []*string) (_err error) {
  ...
  response, _err := AdvanceGenerateDataKey(client, aad, keyId, tea.ToInt32(numberOfBytes))
  if _err != nil {
    return _err
  }
