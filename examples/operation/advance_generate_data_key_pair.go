...
func AdvanceGenerateDataKeyPair (client *kmssdk.Client, keyFormat *string, aad []byte, keyId *string, keyPairSpec *string) (_result *dedicatedkmssdk.AdvanceGenerateDataKeyPairResponse, _err error) {
  request := &dedicatedkmssdk.AdvanceGenerateDataKeyPairRequest{
    KeyFormat: keyFormat,
    Aad: aad,
    KeyId: keyId,
    KeyPairSpec: keyPairSpec,
  }
  _result = &dedicatedkmssdk.AdvanceGenerateDataKeyPairResponse{}
  return client.AdvanceGenerateDataKeyPair(request)
}
...
func _main (args []*string) (_err error) {
  ...
  response, _err := AdvanceGenerateDataKeyPair(client, keyFormat, aad, keyId, keyPairSpec)
  if _err != nil {
    return _err
  }
