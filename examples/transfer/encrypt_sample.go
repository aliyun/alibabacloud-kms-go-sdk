...
// 密钥迁移前示例代码。
func BeforeMigrateEncryptSample() {
...
// 密钥迁移后示例代码。
func AfterMigrateEncryptSample() {
	// 创建kms共享网关config并设置相应参数
	config := &openapi.Config{
		// 设置地域Id
		RegionId: tea.String("your-region-id"),
...
func Encrypt(client *sdk.TransferClient) {
	request := &kms20160120.EncryptRequest{
		KeyId:     tea.String("your-key-id"),
		Plaintext: tea.String("your-plaintext"),
	}
...
func main() {
	NewUserEncryptSample()
	BeforeMigrateEncryptSample()
	AfterMigrateEncryptSample()
}
